    ...
    private void login() {
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(HalamanLogin.this, ActivityRegister.class));
            }
        });
                            ...
                            .addOnCompleteListener(HalamanLogin.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (!task.isSuccessful()) {
                                        Toast.makeText(HalamanLogin.this,
                                        ...
                                        startActivity(new Intent(HalamanLogin.this, AdminActivity.class)
